...
<div class="drawer">
  ...
  <div class="drawer-side">
    ...
    <ul class="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content">
      ...
      <li class="mt-10"><a href="/"><i class="fa fa-house  text-2xl hover:text-3xl hover:animate-pulse"></i>Homepage</a></li>
      <li><a href="{{ Route('blog') }}"><i class="fa fa-newspaper fill-current text-2xl hover:text-3xl hover:animate-pulse"></i>Blog</a></li>
      <li><a href="{{ Route('portofolio') }}"><i class="fa fa-laptop-file fill-current text-2xl hover:text-3xl hover:animate-pulse"></i>Portfolio</a></li>
      <li><a href="{{ Route('about') }}"><i class="fa fa-address-card fill-current text-2xl hover:text-3xl hover:animate-pulse"></i>About</a></li>
